# ======================================================================
# INSTALAÇÃO - EventHandlers v3.8.1 DEBUG (SEM GoTo)
...
Write-Host "║   EventHandlers v3.8.1 DEBUG (SEM GoTo)                 ║" -ForegroundColor Cyan
...
$sourceFile = Join-Path $scriptPath "EventHandlers_v3.8.1_DEBUG_CORRIGIDO.vbs"
...
Write-Host "📝 INSTALANDO v3.8.1 DEBUG (SEM GoTo)..." -ForegroundColor Yellow
try {
...
Write-Host "   ✅ Versão: v3.8.1 DEBUG (SEM GoTo)" -ForegroundColor White
